...
public class DijkstraAlgo {
	public static LinkedList<Integer> Dijkstra(WeightedGraph graph, int start, int end, int numberV, Board board) {
		HashSet<Integer> to_visit = new HashSet<Integer>();
		int number_tries, min_v, to_try;
		double timeFromSourceMinimale;
		...
		while (to_visit.contains(end)) {
			min_v = 0;
			timeFromSourceMinimale = Double.POSITIVE_INFINITY;
