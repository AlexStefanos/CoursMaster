...
{
	// Si les deux champs e-mail sont égaux,
	// on affiche les informations contenues dans les champs.
	if (monFormulaire.email.value === monFormulaire.email_check.value)
		alert(recuperer_champs());
	
	// Sinon, on affiche une message d'erreur.
	else
		alert("Vos deux e-mails sont différents.");
}
