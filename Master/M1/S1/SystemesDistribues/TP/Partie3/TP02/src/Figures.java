...
public class Figures extends ArrayList<Figure>
{
    ...
    {
        this.currentFigure = new Figure(shape, color);
        this.currentFigure.setLocation(x, y);
    }
    ...
    public void resizeCurrentFigure(double width, double height)
    {
        if (this.currentFigure != null) {
            this.currentFigure.setSize(width, height);
        }
    }
     ...
     *
     * @return true if the figure has been added
     */
