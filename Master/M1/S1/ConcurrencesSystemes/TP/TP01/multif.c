/*
   ...
   multif.c  (fork, wait, exit)

   affiche sur la sortie standard les contenus des fichiers
   dont les noms sont passes en parametre de la commande
   chaque fichier est traite par un processus different
